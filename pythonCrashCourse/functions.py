...
# #8-16. Imports:  Using a program you wrote that has one function in it, store that function
# in a separate file.  Import the funtion into your main program file, and call the function
...
# from module_name import *
#greet.py and main.py


#8-17, styling Functions:  Choose any three progams you wrote for this chapter, and
